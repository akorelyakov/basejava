<%@ page import="com.github.akorelyakov.webapp.model.ContactType" %>
...
<%@ page import="com.github.akorelyakov.webapp.model.SectionType" %>
<%@ page import="com.github.akorelyakov.webapp.util.DateUtil" %>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.github.akorelyakov.webapp.model.Organization.Position"/>
                                <dl>
